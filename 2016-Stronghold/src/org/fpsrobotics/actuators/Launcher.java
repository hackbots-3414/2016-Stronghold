...
public class Launcher implements ILauncher
{
	...
	private final int TOP_LIMIT_POT_VALUE = 291;
	private final int BOTTOM_LIMIT_POT_VALUE = 1863;
	...
	{
		if (shooterPot.getCount() <= TOP_LIMIT_POT_VALUE || topLimitShooter.getValue())
		{
			return true;
		}
